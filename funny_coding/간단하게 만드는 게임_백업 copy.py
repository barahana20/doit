...
class Enemy:
    def __init__(self, enemy_size, enemy_width, enemy_height, enemy_x_pos, \
        ...
        print("hp 는 {0}입니다".format(self.enemy_hp))
class Zombie(Enemy):
    def __init__(self):
        Enemy.__init__(self, 1, 2)
...
weapon = Weapon(1,2,3)
wooden_sword1 = Sword.wooden_sword
Enemy(enemy_size, enemy_width, enemy_height, enemy_x_pos, enemy_y_pos, enemy_money, enemy_hp)
